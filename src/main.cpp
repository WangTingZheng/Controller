...
int controller=0;    // storage key hex id
...
void keyChange(){                     //interrupt function
    if(page==1&&controller==HEXN[4]){    // you press playStop button when your screen is page 1
      page=1.1;                          //set page flag to 1.1
    }
    if(page==1.1&&controller==HEXN[3]){  //your press playback button when your screen is page 1.1
